...
import com.kimpu.prdownloaderex1.downloader.Constants;
...
import com.kimpu.prdownloaderex1.downloader.database.DownloadModel;
import com.kimpu.prdownloaderex1.downloader.handler.ProgressHandler;
import com.kimpu.prdownloaderex1.downloader.httpclient.HttpClient;
import com.kimpu.prdownloaderex1.downloader.internal.stream.FileDownloadOutputStream;
import com.kimpu.prdownloaderex1.downloader.internal.stream.FileDownloadRandomAccessFile;
...
public class DownloadTask {
    ...
    Handler mOnProgressHandlerListener;
    ...
    Response run() {
        ...
        try {
            ...
            do {
                ...
                if (request.getOnProgressHandlerListener() != null) {
                    mOnProgressHandlerListener = request.getOnProgressHandlerListener();
                    Message message = Message.obtain();
                    message.what = request.getDownloadId();
                    message.obj = new Progress(request.getDownloadedBytes(), request.getTotalBytes());
                    mOnProgressHandlerListener.sendMessage(message);
                }
