...
package com.kimpu.prdownloaderex1.downloader.request;

import android.os.Handler;

import com.kimpu.prdownloaderex1.downloader.OnCancelListener;
import com.kimpu.prdownloaderex1.downloader.OnDownloadListener;
import com.kimpu.prdownloaderex1.downloader.OnPauseListener;
import com.kimpu.prdownloaderex1.downloader.OnProgressListener;
import com.kimpu.prdownloaderex1.downloader.OnStartOrResumeListener;
import com.kimpu.prdownloaderex1.downloader.Priority;
import com.kimpu.prdownloaderex1.downloader.Response;
import com.kimpu.prdownloaderex1.downloader.Status;
import com.kimpu.prdownloaderex1.downloader.core.Core;
import com.kimpu.prdownloaderex1.downloader.internal.ComponentHolder;
import com.kimpu.prdownloaderex1.downloader.internal.DownloadRequestQueue;
import com.kimpu.prdownloaderex1.downloader.internal.SynchronousCall;
import com.kimpu.prdownloaderex1.downloader.utils.Utils;
...
public class DownloadRequest {
    ...
    private Handler onProgressHandlerListener;
    ...
    public Handler getOnProgressHandlerListener() {
        return onProgressHandlerListener;
    }

    public void setOnProgressHandlerListener(Handler onProgressHandlerListener) {
        this.onProgressHandlerListener = onProgressHandlerListener;
    }
