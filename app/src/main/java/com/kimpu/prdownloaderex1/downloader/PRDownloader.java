...
package com.kimpu.prdownloaderex1.downloader;
...
import com.kimpu.prdownloaderex1.downloader.request.DownloadRequestBuilder;
...
public class PRDownloader {
    ...
    public static List<DownloadRequest> getAllRequest() {
        return DownloadRequestQueue.getInstance().getAllRequest();
    }
